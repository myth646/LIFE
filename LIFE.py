...
def main():
    ...
    for i in range(len(eval_metrics_list)):
        save_to_csv(eval_metrics_list[i], f'LIFE_{args.task_name}_{eval_name[i]}({number_str}).csv')
        append_to_csv('output_seed.csv', f'LIFE_{args.task_name}_{eval_name[i]}({number_str}).csv', args.seed)
